...

{
	...
	//  object.  If it isn't, we need to get out before we __try to reference some
...

{
	...
	//
	//  Acquire the global resource so that we can __try to vaporize the volume, 
...

{
	...
	//  for a REMOVE in the first two cases, as we __try to intiate
	//  dismount.
	//

	//
	//  Acquire the global resource so that we can __try to vaporize
