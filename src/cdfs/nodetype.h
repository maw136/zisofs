...
//
#define CDFS_BUG_CHECK_EXTSTRCT			 (0x001f0000)
#define CDFS_BUG_CHECK_ZINFFAST			 (0x00200000)
#define CDFS_BUG_CHECK_ZADLER32			 (0x00210000)
#define CDFS_BUG_CHECK_ZINFFIXED		 (0x00220000)
#define CDFS_BUG_CHECK_ZINFLATE			 (0x00230000)
#define CDFS_BUG_CHECK_ZINFTREES		 (0x00240000)
#define CDFS_BUG_CHECK_READCOMPR		 (0x00250000)
#define CDFS_BUG_CHECK_ZUTIL				 (0x00260000)
