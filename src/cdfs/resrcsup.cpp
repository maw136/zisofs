...
Routine Description:
    ...
    looks at the IgnoreWait flag to determine whether to __try to acquire the
...
Arguments:
    ...
    Resource - This is the resource to __try and acquire.
    ...
    Type - Indicates how we should __try to get the resource.
